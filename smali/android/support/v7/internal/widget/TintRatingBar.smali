...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 61
    sget-object v2, Landroid/support/v7/internal/widget/TintRatingBar;->TINT_ATTRS:[I
    ...
    .line 66
    invoke-direct {p0, v1}, Landroid/support/v7/internal/widget/TintRatingBar;->tileifyIndeterminate(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-virtual {p0, v2}, Landroid/support/v7/internal/widget/TintRatingBar;->setIndeterminateDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 71
    invoke-direct {p0, v1, v3}, Landroid/support/v7/internal/widget/TintRatingBar;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-virtual {p0, v2}, Landroid/support/v7/internal/widget/TintRatingBar;->setProgressDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method private tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 82
    instance-of v10, p1, Landroid/support/v7/internal/widget/DrawableWrapper;
    ...
    .line 83
    check-cast v10, Landroid/support/v7/internal/widget/DrawableWrapper;

    invoke-virtual {v10}, Landroid/support/v7/internal/widget/DrawableWrapper;->getWrappedDrawable()Landroid/graphics/drawable/Drawable;
    ...
    .line 85
    invoke-direct {p0, v5, p2}, Landroid/support/v7/internal/widget/TintRatingBar;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v10, v5}, Landroid/support/v7/internal/widget/DrawableWrapper;->setWrappedDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v12, v10}, Landroid/support/v7/internal/widget/TintRatingBar;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v10, p0, Landroid/support/v7/internal/widget/TintRatingBar;->mSampleTile:Landroid/graphics/Bitmap;

    if-nez v10, :cond_7

    .line 109
    iput-object v9, p0, Landroid/support/v7/internal/widget/TintRatingBar;->mSampleTile:Landroid/graphics/Bitmap;
...
.method protected declared-synchronized onMeasure(II)V
    ...
    .line 155
    iget-object v1, p0, Landroid/support/v7/internal/widget/TintRatingBar;->mSampleTile:Landroid/graphics/Bitmap;
